...
class DB:
    ...
    def create_user_score_table(self, ):
        self.cur.execute("CREATE TABLE IF NOT EXISTS scores(name , score)")
        self.con.commit()


    def get_top_5(self, ) -> list[UserScore]:
        stmt = f"SELECT name, score FROM scores ORDER BY score DESC LIMIT 5"
    ...
    def save_user_score(self, user_score: UserScore):
        stmt = f"INSERT INTO scores VALUES('{user_score.username}', {user_score.score})"
